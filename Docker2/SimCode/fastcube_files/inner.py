...
class Inner(object):
    ...
    def __init__(self):
        ...
        self.channels[0].setGains((1.5, 0.5, 2)) # roll/aileron
        self.channels[0].setRange([-1, 1])
        self.channels[0].setWrapAround(True)

        self.channels[1].setGains((0.1, 0.001, 1)) # pitch/elevator
        self.channels[1].setRange([-1, -0.2])
        self.channels[1].setSign(-1)

        self.channels[3].setGains((0.0001, 0.000001, 0.001)) # yaw/rudder
        self.channels[3].setRange([-0.125, 0.125])
